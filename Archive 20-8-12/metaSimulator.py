...
endDate = datetime.datetime(2012, 10, 1, 0, 0)
...
genomes = genomeDatabase.find({'expectancy': {'$lt': 4}}).sort('expectancy', -1)
...
while True:
	...
	for x in range( poolSize ):
		...
		evalArray.append( [round(expect,2), 0, wins + losses, wonPips, lostPips, 0] )	
	print evalArray[0]
	generations += 1
