...
treeLength = 6
poolSize = 100
startDate = datetime.datetime(2011, 9, 1, 0, 0)
endDate = datetime.datetime(2012, 3, 1, 0, 0)
...
genomes = genomeDatabase.find({'expectancy': {"$gt": -99}, 'orderType': 'buy', 'ticker': 'AUDUSD' }).sort('trades', 1)
